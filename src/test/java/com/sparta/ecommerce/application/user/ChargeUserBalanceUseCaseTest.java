...
class ChargeUserBalanceUseCaseTest {
    ...
    void 잔액_충전_성공() {
        ...
        ChargeBalanceResponse expectedResponse = new ChargeBalanceResponse(
                userId, previousBalance, chargeAmount, previousBalance + chargeAmount, null
        );

        given(chargeBalanceService.charge(userId, request))
        ...
        verify(chargeBalanceService, times(1)).charge(userId, request);
    }
    ...
    void 잔액_0원에서_충전() {
        ...
        ChargeBalanceRequest request = new ChargeBalanceRequest("txn-test-" + System.nanoTime(), chargeAmount);
        ChargeBalanceResponse expectedResponse = new ChargeBalanceResponse(
                userId, 0L, chargeAmount, chargeAmount, null
        );
    ...
    void 큰_금액_충전() {
        ...
        ChargeBalanceRequest request = new ChargeBalanceRequest("txn-test-" + System.nanoTime(), chargeAmount);
        ChargeBalanceResponse expectedResponse = new ChargeBalanceResponse(
                userId, previousBalance, chargeAmount, 11000000L, null
        );
